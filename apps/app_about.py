...
for i in range(master_funds.shape[0]):
    images_div.append(
        gen_thumbnail2(master_funds.logo[i], master_funds.url[i], master_funds.fund[i])
    )
...
layout = html.Div(
            ...
            [
                dbc.Row(
                    [
                        ...
                        #     dbc.Row(
                        #         dbc.Col(
                        #             html.Label('Valuations aggregated from over 2000+ mutual funds including
                        #                                 funds managed by:'),
    ...
    Alongside this shift has been a trend of increasing pre-IPO participation by crossover investors including many
    mutual funds.
    ...
    * Follow this [link][6] to search all reported Level 3 fair values submitted by mutual funds to the SEC
    ...
    groups began with quarter ending March 31, 2020. However, the first 6 months of Form N-PORT filings were kept
    private so the first publicly available Form N-PORT filings begins with quarter ending September 30, 2019.
    The submission deadlines are 60 days after each fiscal quarter end.
                        ...
                        dbc.Col(
                            [
                                ...
                                dbc.Row(
                                    dbc.Col(
                                        html.Label(
                                            "Valuations aggregated from over 2000+ mutual funds including funds "
                                            "managed by:"
                                        ),
                                        style={
                                ...
                                dbc.Row(dbc.Col(images_div, style={})),
                            ],
                            width=2,
                            style={"padding-bottom": "30px", "textAlign": "center"},
                        ),
...
#     * Form N-PORT expands the scope of required level of detail much of which was not previously required with
#     Form N-Q
